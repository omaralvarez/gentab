...
class MLPClassifier:
    ...
    def fit(self, X, y) -> Self:
        ...
        # print(X)
        # print(y.dtype, X.to_numpy().dtype)
        # exit()
        # _______________marks_____________
        # self.net.fit(X=X.to_numpy().astype(float), y=y)
    ...
    def predict(self, X):
        # _______________marks_____________
        # predictions = self.net.predict_proba(X.to_numpy().astype(float))
