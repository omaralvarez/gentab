...
class MLPGorishClassifier:
    def __init__(
        ...
        **kwargs,
        ...
        self.model = MLP.make_baseline(input_features, layers, dropout, num_classes)
...
class MLPGorish(Evaluator):
    def __init__(
        ...
        **kwargs,
        ...
        self.model = MLPGorishClassifier(
